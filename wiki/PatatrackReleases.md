...
`CMSSW_11_2_0_pre7_Patatrack` is available for the architectures:
...
```
```bash
scram list CMSSW_11_2_0_pre7_Patatrack
...
--------------------------------------------------------------------------------
  ...
  CMSSW           CMSSW_11_2_0_pre7_Patatrack
                                         --> /cvmfs/cms.cern.ch/slc7_amd64_gcc820/cms/cmssw/CMSSW_11_2_0_pre7_Patatrack
```
...
and can be installed directly with:
```bash
$VO_CMS_SW_DIR/common/cmspkg -a $SCRAM_ARCH install -y cms+cmssw+CMSSW_11_2_0_pre7_Patatrack
```
