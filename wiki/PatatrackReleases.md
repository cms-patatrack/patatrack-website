...
The old Patatrack stable branch is based on `CMSSW_11_1_X`, and
...
supports CUDA 11.1 and GCC 9 and later.
...
export LANG=C
export VO_CMS_SW_DIR=$PWD
export SCRAM_ARCH=slc7_amd64_gcc820     # for 11.1.x releeases
export SCRAM_ARCH=slc7_amd64_gcc900     # for 11.2.x releases
...
and can be installed directly with:
```bash
$VO_CMS_SW_DIR/common/cmspkg -a $SCRAM_ARCH install -y cms+cmssw+CMSSW_11_2_1_Patatrack
```
